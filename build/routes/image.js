...
imageRouter.get("/app", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                heightUrl = Number(req.query.height);
                widthUrl = Number(req.query.width);
                nameUrl = String(req.query.name);
                img = new data_1.Imag(nameUrl, heightUrl, widthUrl);
                (0, functionality_1.checkingFolder)();
                _a.label = 1;
            case 1:
                _a.trys.push([1, 6, , 7]);
                if (!fs_1.default.existsSync(path_1.default.resolve("./src") +
                    "/edited-images/".concat(img.name, "-").concat(img.height, "-").concat(img.width, ".jpg"))) return [3 /*break*/, 2];
